		...
		<>
			<nav className="flex items-center sm:border-b-[1px] mx-5 py-4 px-2 sm:p-0 relative sm:static">
				<div
					...
					<img src={menuIco} alt="" className="h-4" />
				</div>
				...
				<div className="flex items-center w-full py-1 sm:py-0">
					...
					<div
						...
						<img src={cartIco} alt="cart" className="h-5 translate-y-[-1px]" />
						{cart[0].quantity! > 0 && (
					...
					<div className="hover:border-orange border-2 border-transparent rounded-full">
						<img
							src={avatar}
							alt="user"
							className="sm:h-14 h-6 cursor-pointer"
						/>
					</div>
				</div>
			</nav>
			{windowWidth < 441 && (
				<div
					...
					<div
						...
						<img src={closeIco2} alt="" className="h-5" />
					</div>
